...
export function AttendanceInsights({ report }: { report: AttendanceReportRow[] }) {
  ...
  }), { presentDays: 0, absentDays: 0, lateMinutes: 0, workedMinutes: 0, compliance: 0 }), [report]);
